// web/app/archive/hr/detail/page.tsx
'use client'
...
function ArchiveHrDetailContent() {
    ...
    return (
      ...
      >
        <p className="text-gray-600">
          잘못된 경로입니다. 인사자료실 목록에서 다시 선택해주세요.
        </p>
      </PageShell>
    )
  }
  ...
  return (
    ...
    >
      ...
      <div className="mt-6">
        <button
          onClick={() => router.push('/archive/hr')}
...
export default function ArchiveHrDetailPage() {
  return (
    <Suspense fallback={
      <PageShell title="인사자료실" subtitle="로딩 중...">
        <div className="flex items-center justify-center py-12">
          <p className="text-gray-600">로딩 중...</p>
        </div>
      </PageShell>
    }>
      <ArchiveHrDetailContent />
    </Suspense>
  )
}
